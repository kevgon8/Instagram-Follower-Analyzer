## CS50P final project | Instagram Followers Analyzer
## Kevin Gonsalves
## github: kevgon8 :: edX: kevgon8
## Mumbai, India
## July 11th, 2024
...
#func to store each line of txtwidget input seperately
def process_txtwidget_input(text_widget):
    '''
    text_widget: (input) content entered in textwidget 
    returns: set1; set containing each line without repetition
    '''
    set1 = set()
    k = 1
    while True:
...
#func to create txtfile
def create_file(set, filename):
    '''
    set: set containing each line of txtwidget
    filename: name of txtfile
    returns: nothing; creates a txtfile
    '''
